          ...
          <span className=" md:hidden">Save </span>
                ...
                <div className="newsleter py-2 ">
                  ...
                  <div className="  md:flex md:items-center md:justify-between relative w-full  ">
                    ...
                    <Link href="/m/Signin">
                      <a className="flex items-center border border-gray-400 hover:border-gray-600 rounded-full py-3 px-4 w-fit lg:w-max text-sm lg:text-lg mt-3 lg:mt-0 relative  ">
