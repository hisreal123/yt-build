          ...
          <span className=" md:hidden">Save </span>
                ...
                <div className="newsleter py-2 ">
                  ...
                  <div className="  md:flex md:items-center md:justify-between relative w-full  ">
                    <p className="text-gray-500 text-[10px] md:text-md leading-3 md:w-fit ">
                      By signing up, you will create a Medium account if you
                      don’t already have one. Review our Privacy Policy for more
                      information about our privacy practices.
                    </p>
                    <Link href="/m/Signin">
                      <a className="flex items-center lg:justify-between border border-gray-400 hover:border-gray-600 rounded-full py-3 px-4 w-fit lg:w-max text-sm  mt-3 lg:mt-0 relative  ">
