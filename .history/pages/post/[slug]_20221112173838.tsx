...
function Post({ post }: PostProps) {
  return (
    <>
      <Head>
        <title className="truncate"> postpage</title>
      </Head>
        ...
        <div className="ab md:hidden flex items-center space-x-2 md:space-x-0 text-xl text-gray-700 border border-gray-400 relaive w-fit px-4 py-1 rounded-full  hover:border-gray-600 md:border-0">
          ...
          <span className=" md:hidden">Save </span>
                ...
                <div className="newsleter py-2 ">
                  ...
                  <p className="text-[13px]">{`By ${post.author.name}`}</p>
                  <p className="deliver text-[12px]  my-4">
                    {" "}
                    Every Thursday, the Variable delivers the very best of
                    Towards Data Science: from hands-on tutorials and
                    cutting-edge research to original features you don't want to
                    miss. Take a look.
                  </p>
                  <div className="  md:flex md:items-center md:justify-between relative w-full  ">
                    <p className="text-gray-500 text-[10px] md:text-md leading-3 md:w-[60%] ">
                      By signing up, you will create a Medium account if you
                      don’t already have one. Review our
                      <Link href="https://policy.medium.com/medium-privacy-policy-f03bf92035c9?source=register-------------------------------------">
                        <a className=" underline mr-[1px]"> Privacy Policy</a>
                      </Link>
                      for more information about our privacy practices.
                    </p>
                    <Link href="/m/Signin">
                      <a className="flex items-center border border-gray-400 hover:border-gray-600 rounded-full py-3 px-4 w-fit lg:w-max text-sm  mt-3  lg:mt-0 relative  ">
                        <BsEnvelope className="mr-2 text-lg" />
                        Get this newsletter
                      </a>
                    </Link>
                  </div>
