  ...
  return (
    <div className="p-3 border-r lg:h-screen lg:w-auto sm:w-screen fixed bottom-0 bg-white z-20 w-full lg:min-w-[5%] shadow-lg lg:shadow-0  ">
      <div className="mobile flex items-center justify-between mx-auto lg:hidden max-w-[80%] ">
        <SlHome className=" text-xl text-gray-400 hover:text-gray-800 cursor-pointer ml-" />
        <CiSearch className="  text-xl text-gray-400 hover:text-gray-800 cursor-pointer mb-        <CgProfile className="  text-xl text-gray-400 hover:text-gray-800 cursor-pointer mr-" />
      </div>
