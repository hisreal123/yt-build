    ...
    <div className="p-3 lg:p-0  border-r lg:h-screen lg:w-auto  fixed lg:block bottom-0 bg-white z-10 w-full lg:min-w-[5%] lg:shadow-0  ">
      ...
      <div className="lgScreen hidden lg:flex lg:flex-col pt-10  justify-between items-center  relative h-full text-2xl ">
        ...
        <div className="in space-y-10 -mt-20">
          <SlHome className=" cursor-pointer font-text-gray-500 hover:text-gray-700 " />
          <HiOutlineBell className=" cursor-pointer font-text-gray-500 hover:text-gray-700 " />
          <BsFillBookmarksFill className=" cursor-pointer font-text-gray-500 hover:text-gray-700 " />
          <CiViewList className="cursor-pointer font- text-gray-500 hover:text-gray-700 " />
          <div className="inA pt-10 border-t border-gray-400 ">
            <TfiWrite className=" cursor-pointer font-text-gray-500 hover:text-gray-700 " />
          </div>
        </div>
