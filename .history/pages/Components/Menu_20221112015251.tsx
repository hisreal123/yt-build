...
function Menu() {
  return (
    <div className="p-3 border-r lg:h-screen lg:w-auto  fixed bottom-0 bg-white z-10 w-full lg:min-w-[5%] shadow-lg lg:shadow-0  ">
      <div className="mobile flex items-center justify-between mx-auto lg:hidden max-w-[80%] ">
        <SlHome className=" shadow-sm  text-2xl text-gray-400 hover:text-gray-800 cursor-pointer ml-3 " />
