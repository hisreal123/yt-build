  ...
  return (
    <div className="py-5 ">
      <form action="" method="post" className="space-y-10">
        ...
        <div className="ab flex items-center space-x-2 md:space-x-0 text-xl text-gray-700 border border-gray-400 relaive w-fit px-4 py-1 rounded-full  hover:border-gray-600 md:border-0">
          <CiBookmarkPlus />
          <span className=" md:hidden">Save </span>
        </div>
      </form>

      <p className=" mt-5  text-[10px] leading-3">
