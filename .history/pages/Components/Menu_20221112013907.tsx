...
function Menu() {
  return (
    <div className="p-3 border-r lg:h-screen lg:w-auto sm:w-screen fixed bottom-0 bg-white z-20 w-full lg:min-w-[5%] flex items-center justify-between  ">
      <SlHome className="lg:hidden text-md text-gray-400 h" />
      <CiSearch className=" lg:hidden text-md text-gray-400 h" />
      <CgProfile className=" lg:hidden text-md text-gray-400 h" />
