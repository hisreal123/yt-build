...
function Socials({ addStyle }: SocialsProps) {
  return (
    <div className={`${addStyle}`}>
      ...
      <Tippy content={<span className="bg-gray-900 text-white text-xs  px-2 py-1 rounded-md "> instagramm </span>}>
      <motion.p
        initial={{ y: -300 }}
        animate={{ y: 0 }}
      ...
      <Tippy content={<span className="bg-gray-900 text-white text-xs  px-2 py-1 rounded-md "> Copy to clipboard </span>}>
      <motion.p
        initial={{ y: -300 }}
        animate={{ y: 0 }}
