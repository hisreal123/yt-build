...
function CreateAccount() {
  return (
    <div className="h-screen w-screen flex flex-col justify-center items-center">
      ...
      <div className="social -translate-y-10 space-y-3 ">
        <Link href=" https://medium.com/m/connect/google?state=google-%7Chttps%3A%2F%2Fmedium.com%2Fnew-story%3Fsource%3Dregister-------------------------------------%7Cregister&source=register-------------------------------------">
          <a className="w-full  space-x-2 flex  items-center py-2 px-4 border border-gray-400  w-fit rounded-full text-gray-600 hover:text-gray-800 hover:border-gray-600">
            <FcGoogle />
