  ...
  return (
    <div className="h-screen w-screen">
      <div className="lg:shadow-2xl lg:max-w-2xl lg:mx-auto  h-full bigScreen  flex flex-col justify-center items-center">
        <div className="tp -translate-y-32 text-center ">
        ...
        <div className="btn flex  text-sm mt-10 text-gray-600 font-medium  ">
          <p> No account ?Forgot email or trouble signing in? </p>
          <Link href="https://help.medium.com/hc/en-us/requests/new?ticket_form_id=9455427953559&form=true&source=login--------------------------follow_footer-----------"></Link>
