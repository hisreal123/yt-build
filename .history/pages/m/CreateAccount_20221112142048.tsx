...
function CreateAccount({ changeState }: CreateAccountProps) {
  return (
    <div className="h-screen w-screen flex flex-col justify-center items-center">
      ...
      <div className="notice text-center relative w-[60$">
        <p className=" relative">that Medium’s Privacy Policy applies to you.</p> Click “Sign Up” to
        agree to Medium’s Terms of Service and acknowledge
      </div>
    </div>
  );
}
