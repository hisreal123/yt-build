  ...
  return (
    <div className="h-screen w-screen  ">
      <div className="lg:shadow-2xl lg:max-w-2xl lg:mx-auto  h-full bigScreen  flex flex-col justify-center items-center">
        <div className="tp mb-10  text-center ">
        ...
        <div className="btn flex items-center   text-sm mt-10 text-gray-600 font-medium  ">
          <p> No account ? </p>
          <button
            onClick={changeState}
        ...
        <div className="gethelp flex justify-center relative w-[80%] mx-auto text-sm mt-10 text-gray-600 ">
          ...
          <Link href="https://help.medium.com/hc/en-us/requests/new?ticket_form_id=9455427953559&form=true&source=login--------------------------follow_footer-----------">
            <a className=" underline ml-1">Get help </a>
          </Link>
        </div>

        <div className="notice text-center relative w-[80%] mx-auto translate-y-16 ">
