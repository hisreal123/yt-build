    ...
    <div className="h-screen w-screen flex flex-col justify-center items-center">
      ...
      <div className="notice text-center relative w-[60%] mx-auto ">
        <p className=" relative">
          ...
          <Link href="https://policy.medium.com/medium-terms-of-service-9db0094a1e0f?source=register-------------------------------------"></Link>Terms of Service and acknowledge
          that Medium’s <Link href={}></Link>Privacy Policy applies to you.
        </p>
      </div>
    </div>
  );
